...
export const agendaEvents: AgendaEvent[] = [
  ...
  },
  {
    ...
    place: 'La Mola · 9:00–14:00h',
    placeEs: 'La Mola · 9:00–14:00h',
    placeEn: 'La Mola · 9:00–14:00h',
    desc: "La festa de l'estiu ha tornat. WOD, música, gresca i xerinola.",
    descEs: 'La fiesta del verano ha vuelto. WOD, música y mucha fiesta.',
    descEn: 'The summer party is back. WOD, music and a great vibe.'
  },
  {
    id: 'pool-party',
    start: '2026-07-19',
    ...
    cat: 'festa',
    name: 'La Mola Pool Party',
    nameEs: 'La Mola Pool Party',
    nameEn: 'La Mola Pool Party',
    place: 'La Mola · 10:00–20:00h',
    placeEs: 'La Mola · 10:00–20:00h',
    placeEn: 'La Mola · 10:00–20:00h',
    desc: 'WOD, piscina, BBQ, música, billar i futbolí. La festa refrescant de l\'estiu.',
    descEs: 'WOD, piscina, BBQ, música, billar y futbolín. La fiesta refrescante del verano.',
    descEn: 'WOD, pool, BBQ, music, pool table and foosball. The summer\'s coolest party.',
  ...
  },
  {
    ...
    cat: 'activitat',
    name: 'Simulacre Wodcelona · Teams of 3',
    nameEs: 'Simulacro Wodcelona · Teams of 3',
    nameEn: 'Wodcelona Simulation · Teams of 3',
  ...
  },
  {
    ...
    cat: 'activitat',
    name: 'Simulacre Costa Brava · Teams WOD (1r)',
    nameEs: 'Simulacro Costa Brava · Teams WOD (1º)',
    nameEn: 'Costa Brava Simulation · Teams WOD (1st)',
    place: 'La Mola · Teams WOD · Gratuït',
    placeEs: 'La Mola · Teams WOD · Gratis',
    placeEn: 'La Mola · Teams WOD · Free',
    desc: 'Primer simulacre per equips de cara a la FCL Costa Brava.',
    descEs: 'Primer simulacro por equipos de cara a la FCL Costa Brava.',
    descEn: 'First team simulation ahead of FCL Costa Brava.',
    image: `${AGENDA_REPO_RAW}/evento-costa-brava-fitness-02.jpg`
  },
  {
    id: 'sim-costabrava-2',
    start: '2026-10-10',
    ...
    cat: 'activitat',
    name: 'Simulacre Costa Brava · Teams WOD (2n)',
    nameEs: 'Simulacro Costa Brava · Teams WOD (2º)',
    nameEn: 'Costa Brava Simulation · Teams WOD (2nd)',
    place: 'La Mola · Teams WOD · Gratuït',
    placeEs: 'La Mola · Teams WOD · Gratis',
    placeEn: 'La Mola · Teams WOD · Free',
    desc: 'Segon simulacre per equips abans de la FCL Costa Brava.',
    descEs: 'Segundo simulacro por equipos antes de la FCL Costa Brava.',
    descEn: 'Second team simulation before FCL Costa Brava.',
    image: `${AGENDA_REPO_RAW}/community-1.jpg`
  },
  {
    id: 'hyrox-bcn',
    start: '2026-11-11',
  ...
  {
    id: 'fitrace-costa-brava',
    start: '2026-10-17',
    end: '2026-10-17',
    cat: 'comp-ext',
    name: 'Fit Race Costa Brava',
    nameEs: 'Fit Race Costa Brava',
    nameEn: 'Fit Race Costa Brava',
